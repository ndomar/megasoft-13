...
ActiveRecord::Schema.define(:version => 20130407171837) do
...
# Could not dump table "step_answers" because of following StandardError
#   Unknown type 'Step' for column 'belongs_to'
